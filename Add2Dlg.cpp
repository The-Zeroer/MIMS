...
void Add2Dlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDITadd2passworld1, m_add2passworld1);
	DDX_Text(pDX, IDC_EDITadd2passworld2, m_add2passworld2);
...
void Add2Dlg::OnBnClickedOk()
{
	...
	//判断用户信息是否完整
	if (m_add2username == "" || m_add2passworld1 == "" || m_add2passworld2 == "")
	{
		MessageBox("用户信息不完整!");
		return;
	}
	...
	//判断两次输入的密码是否相同
	if (m_add2passworld1 != m_add2passworld2)
	{
	...
	udata.passworld = m_add2passworld1.GetString();
